# Generated by Django 2.1.7 on 2019-11-28 05:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_num', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='book.Book')),
                ('c_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='book.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.AddField(
            model_name='buy',
            name='c_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='book.Customer'),
        ),
        migrations.AddField(
